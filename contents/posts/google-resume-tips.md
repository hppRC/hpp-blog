...
DeepLにそのままMarkdownで書き起こした文字を通したらなんかヒソカみたいになったんですが、面白いのでそのまま掲載します
...
- ビジネスとインターンシップの役割は1ページにとどめ、エンジニアリングと技術的な役割は2ページ以内に収める
- 特定の役割に関連するものを含める
...
GPAは要因の一つですが、私たちは全体のパッケージを見て、すべての学校と学生が異なることを理解しています。
...
**Zを行うことで、Yで測定したXを達成する。

例：APIの再構築により、サーバへの問い合わせ応答時間を15%向上させた。

## リーダーシップと賞

最初のステートメントは、メトリクスを含めることで、より強力なものにすることができます。

例） リーダーシップの可能性と学業面での成功に基づいて、技術分野で高い成果を上げている黒人やラテン系の人材を対象とした18ヶ月間の専門能力開発プログラムの全国230人の参加者のうちの1人に選ばれました。
...
- インパクトを伝えるために、**Z.**フレームワークを使用して、Yを行うことによって測定されたXを達成する
- リンクする項目
  - 出版物
  - 論文
  - 特許
...
Googleへの応募準備に役立つリソースについては、説明文のリンクをチェックして、キャリアサイトにアクセスして求人情報やインターンをご覧ください。
