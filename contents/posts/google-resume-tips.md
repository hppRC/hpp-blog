...
下の方に DeepL に適当に通して日本語訳したものもおいてあります。
...
So if you're student, be sure to include an impact from things like academic research, teaching or tutoring experience, personal projects, and student group and class projects.
...
DeepL にそのまま Markdown で書き起こした文字を通したらなんかヒソカみたいになったんですが、面白いのでそのまま掲載します
...
- シンプルで一貫性のあるデザイン、フォント、サイズ、間隔を使用します。
- 黒または濃くて読みやすいインクを使用してください。
- PDF としてのフォーマット

### コンテンツ

- 上部に連絡先とメールアドレスを記載してください。
- 客観的な文を入れる必要はない
- 参考文献を含める必要はありません

## ♪ 長さ

- ビジネスとインターンシップの役割は 1 ページにとどめ、エンジニアリングと技術的な役割は 2 ページ以内に収める
- 特定の役割に関連するものを含める
- 長い段落ではなく、一貫した書式と構造を持つ箇条書きのポイントを使用してください。
- 誤字脱字チェック

### 技術者・技術者候補者の方へ

- プログラミング言語をトップにリストアップ
- GitHub のプロフィールやその他の著名なオープンソース作品をリストアップする

### ♪♪ ポイントは？

- 学生の場合）※※教育は必ず最初に記載してください。
- 複数の異なる経験のカテゴリーがある場合は、それぞれにサブセクションを作成することを検討してください。次に個人的なこと、クラスのプロジェクトを含めてください。
- あなた自身について話すための任意のセクションを作成することができます。

## 教育

- これまでに通ったすべての中等教育機関、およびすべての学位と専攻を含む。
- 最新の学歴が最初に記載されていることを確認してください。
- 実際の卒業日を月年形式で記載する
  - 例：2017 年 5 月
...
GPA は要因の一つですが、私たちは全体のパッケージを見て、すべての学校と学生が異なることを理解しています。

## ♪ ♪ 経験を積む

経験は、仕事やインターンシップ以外にも様々な形でもたらされる可能性があります。
学生の場合は、学術研究、教育や個人指導の経験、個人的なプロジェクト、学生グループやクラスのプロジェクトなどの影響を必ず含めてください。

\*\*技術職や技術職に応募する場合は、オープンソース、モバイルアプリやウェブ開発、ハッカソン、コーディングコンテストなどの経験を必ず含めてください。

- 時系列を逆にして、最近の経験が多い順に記入してください。
- すべての仕事とインターンシップについて、雇用主、役職、採用日を月単位で記入してください。
- 箇条書きの説明は簡潔で明確であるべきである
- 次の行にこぼれる箇条書きを 1 ～ 2 語だけで合理化する
- 作成、設計、デバッグ、ネゴシエート、開発、管理などのアクションワードを使用します。
- メトリクスと例をリストアップする
- 文脈を提供するために、日付と企業または平均値を使用します。
- 含めるプロジェクトごとに、使用したプログラミング言語を太字で記入してください。

### 大事なお知らせ

仕事内容を読むためには、職務経歴書に使われている言葉に注目しましょう。
\*\*特定の仕事内容に合わせて履歴書を書くことは、少し手間がかかりますが、あなたの応募を際立たせることができます。
仕事内容に関連するキーワードを太字や斜体にして、自分のスキルや経験をアピールすることもできます。

### 実績を記述するための良いフレームワーク

\*\*Z を行うことで、Y で測定した X を達成する。

例：API の再構築により、サーバへの問い合わせ応答時間を 15%向上させた。

## リーダーシップと賞

最初のステートメントは、メトリクスを含めることで、より強力なものにすることができます。

例） リーダーシップの可能性と学業面での成功に基づいて、技術分野で高い成果を上げている黒人やラテン系の人材を対象とした 18 ヶ月間の専門能力開発プログラムの全国 230 人の参加者のうちの 1 人に選ばれました。

## ♪ ♪ オプションの最終セクション

他にも何か知っておくべきことがあれば 記入してください あなたの特徴を知ることが好きなので
これは、あなたが現在学生である場合は特に重要です。

- 特に指導的立場にある場合は、学生グループへの参加も含めてください。
- インパクトを伝えるために、**Z.**フレームワークを使用して、Y を行うことによって測定された X を達成する
- リンクする項目
  - 出版物
  - 論文
  - 特許
  - 学会発表
- その他意味のある課外活動や経験があれば追加してください。

### ヒント

Google への応募準備に役立つリソースについては、説明文のリンクをチェックして、キャリアサイトにアクセスして求人情報やインターンをご覧ください。
